...
- For the projects listing, on rollover, have the background set to the specific artwork to match that game. When the Mouse moves again, unset the background(?).
